            ...
            <div id="form-cliente" style="display:block">
                <div class="row">
                    <div class="mb-3 col-12 col-md-4">
                        ...
                        <input type="text" class="form-control" id="rut" value="12.345.678-9" name="rut" required>
            ...
            <div id="form-administrativo" style="display:none">
                ...
                <div class="row">
                    <div class="mb-3 col-12 col-md-4">
                        ...
                        <input type="text" class="form-control" id="experienciaPrevia"  name="experienciaPrevia" required>
                    </div>
                </div>
            </div>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/scripts/validaUsuario.js"></script>
</body>
